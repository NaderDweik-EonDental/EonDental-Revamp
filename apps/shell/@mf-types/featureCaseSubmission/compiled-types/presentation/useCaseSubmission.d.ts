import { type CaseApi, type SubmitCaseResult } from '../application/submitCase.js';
import { type AttachmentType, type CaseConfig, type CaseDraft, type ImpressionMethod, type PrescriptionAnswers } from '../domain/caseRules.js';
